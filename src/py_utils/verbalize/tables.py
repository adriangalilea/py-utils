...
UNITS: Dict[str, Dict[str, str]] = {
    "spanish": {
        ...
        r"(?<![a-zA-Z])mph(?![a-zA-Z])": " millas por hora",
        r"(?<![a-zA-Z])m/s(?![a-zA-Z])": " metros por segundo",
        r"(?<![a-zA-Z])hPa(?![a-zA-Z])": " hectopascales",
        r"(?<![a-zA-Z])mbar(?![a-zA-Z])": " milibares",
        r"(?<![a-zA-Z])mmHg(?![a-zA-Z])": " milímetros de mercurio",
    ...
    "english": {
        ...
        r"(?<![a-zA-Z])mph(?![a-zA-Z])": " miles per hour",
        r"(?<![a-zA-Z])m/s(?![a-zA-Z])": " meters per second",
        r"(?<![a-zA-Z])hPa(?![a-zA-Z])": " hectopascals",
        r"(?<![a-zA-Z])mbar(?![a-zA-Z])": " millibars",
        r"(?<![a-zA-Z])mmHg(?![a-zA-Z])": " millimeters of mercury",
