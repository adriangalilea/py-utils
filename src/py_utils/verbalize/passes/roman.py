...
_ORDINAL_TRIGGERS_ES: Set[str] = {
    "Felipe", "Juan", "Carlos", "Alfonso", "Fernando", "Isabel", "Pedro",
    "Luis", "Enrique", "Ricardo", "Jorge", "Eduardo", "Pío", "Pablo",
    "Benedicto", "Francisco", "Gregorio", "León", "papa", "rey", "reina",
    "Juan Pablo", "capítulo", "tomo", "volumen",
}
_ORDINAL_TRIGGERS_EN: Set[str] = {
    "King", "Queen", "Pope", "Prince", "Princess", "Chapter", "Volume",
    "Henry", "Edward", "George", "Louis", "Charles", "James", "Richard",
}
